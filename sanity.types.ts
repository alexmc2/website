...
export type MenuSection = {
  ...
  background?: {
    ...
    texturePreset?: "paper" | "canvas";
    textureTint?: "background" | "primary" | "secondary" | "card" | "accent" | "destructive" | "muted";
    customImage?: {
      asset?: {
        _ref: string;
        _type: "reference";
...
export type AllSanitySchemaTypes = MenuSection | AllPosts | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | GridRow | GridPost | PricingCard | GridCard | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | SectionHeader | HeroFull | Hero2 | Hero1 | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Settings | Navigation | Testimonial | Faq | Category | Page | Post | Author | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    background: {
      ...
      colorVariant: "accent" | "background" | "card" | "destructive" | "muted" | "primary" | "secondary" | null;
      texturePreset: "canvas" | "paper" | null;
      textureTint: "accent" | "background" | "card" | "destructive" | "muted" | "primary" | "secondary" | null;
      customImage: {
        asset: {
          _id: string;
          url: string | null;
