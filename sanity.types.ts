...
export type LottieAnimation = {
  ...
  verticalSpacing?: "none" | "compact" | "comfortable" | "roomy";
...
export type AllSanitySchemaTypes = LottieAnimation | MenuSection | AllPosts | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | GridRow | GridPost | PricingCard | GridCard | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | SectionHeader | HeroFull | Hero2 | Hero1 | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Settings | Navigation | Testimonial | Faq | Category | Page | Post | Author | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    verticalSpacing: "comfortable" | "compact" | "none" | "roomy" | null;
